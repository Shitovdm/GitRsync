...
/*run_process.js*/
    ...
    window.ExecTerminal = function(parentelem, options) {
        ...
        var allowterminalfit = true;
        var $this = this;

        $this.terminal = new window.Terminal();

        var elems = {
            terminalelem: document.getElementById(parentelem)
        };

        // Attach the Xterm.js terminal.

        //console.log(elems.terminalelem);
        ...
        var newrows = Math.round((document.documentElement.clientHeight * 0.5) / $this.terminal._core.renderer.dimensions.actualCellHeight);
        ...
        // Internal functions.
        $this.UpdateTerminalFit = function() {
